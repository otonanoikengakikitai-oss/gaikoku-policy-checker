...
# 出典: 埼玉県「議会提出予算説明書」（本年度予算額・千円単位）。
# 予算階層は 款=総務費／項=県民費／目=国際交流費 で、外国人特化の抽出単位はその下位の
# 「説明事業」= 多文化共生推進事業費（多言語相談・日本語教育・地域づくり等）＋
# 外国人地域生活支援事業費（外国人総合相談センター）。全県民向けの事業は含まない。
# 一般会計総額は各年度「当初予算案の概要」PDFの実額表記で対比する。
PREF_GOVERNMENT = "埼玉県"
PREF_BASIS_NOTE = (
    "埼玉県の外国人特化予算（県民生活部国際課の「多文化共生推進事業費」＋「外国人地域生活支援事業費」の"
    "説明事業別当初予算額。款・項・目は総務費・県民費・国際交流費）。多言語相談・日本語教育・外国人総合相談センター等で、"
    "全県民向けのインフラ・福祉等は含まない。金額は千円単位の予算説明書ベース。"
)
PREF_TREND_NOTE = (
